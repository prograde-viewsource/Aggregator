four51.app.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
	...
	$routeProvider.
		...
		when('/approvals', { templateUrl: 'partials/approvalsView.html', controller: 'ApprovalsCtrl' }).
		...
		when('/aggregatoradmin', { templateUrl: 'partials/aggregatorAdminView.html', controller: 'AggregatorAdminCtrl' }).
